...
func TestSaaSFeeInfo(t *testing.T) {
	req := request.SaaSFeeInfoRequest{}
	req.CompanyName = "go测试公司-1"
...
func TestSaaSFeeInit(t *testing.T) {
	req := request.SaaSFeeInitRequest{}
	req.CompanyName = "go测试公司-1"
	req.InitialBalance = "20000"
	req.InitialPrice = "2"
	req.PayMode = "POST_PAID"
...
func TestSaaSFeeUpdate(t *testing.T) {
	req := request.SaaSFeeUpdateRequest{}
	req.CompanyName = "go测试公司-1"
	req.InitialBalance = "20000"
	req.InitialPrice = "1"
	req.PayMode = "PRE_PAID"
...
func TestSaasPlatformFee(t *testing.T) {
	req := request.SaasPlatformFeeRequest{}
