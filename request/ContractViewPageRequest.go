...
type ContractViewPageRequest struct {
	...
	DownloadButton *bool  `json:"downloadButton,omitempty"`
	PrintButton    *bool  `json:"printButton,omitempty"`
}
...
func (obj ContractViewPageRequest) GetHttpParameter() *http.HttpParameter {
	...
	parameter.AddParam("downloadButton", obj.DownloadButton)
	parameter.AddParam("printButton", obj.PrintButton)
	return parameter
}
